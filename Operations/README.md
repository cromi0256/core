...
- Model evaluation : [Apache MLlib], [TFMA, Deepchecks], [MLflow, W&B], [What-If Tool], [SHAP, LIME, Captum]
- Model serving : [KServe], [NVIDIA Triton Inference Server, TensorFlow Serving, TorchServe], [Seldon Core], [KEDA, GCP Vertex AI, AWS SageMaker Endpoints], [Alibi Explain], [Prometheus, Grafana]
- Online experimentation : <카나리, 섀도 배포>, <A/B 테스트>, <MAB 테스트>
- Model monitioring : [Prometheus, Grafana], [Evidently AI, WhyLogs], [MLflow]
- ML pipelines : [Apache Airflow, Argo Workflows], [ZenML, Kubeflow Pipelines SDK], [MLMD, MLflow], [TFX, Kubeflow Pipelines Components], [Metaflow], [Kubeflow Pipelines UI]
- Model registry : [Mlflow], [Model Card Toolkit], [GitLab, GitHub Actions]
